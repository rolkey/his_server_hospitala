...
@Index('PK_G90_SJDZ_MX', ['xh'], { unique: true })
@Entity('G90_SJDZ_MX', { schema: 'dbo' })
export class G90SjdzMx {
  ...
  @Column('varchar', { name: 'refd_setl_flag', nullable: true, length: 3 })
  refdSetlFlag: string | null;

  @Column('varchar', { name: 'msgid', nullable: true, length: 30 })
  msgid: string | null;
